        ...
        columns: [
            ...
            { data: "slug" },
            {
                ...
                render: function (data) {
                    ...
                    return `<span title="${data.replace(
                        /"/g,
                        "&quot;"
                    )}">${text}</span>`;
                },
        ...
        if (e.target.closest(".edit-btn")) {
            ...
            fetch(categoriesUpdateUrl.replace(":id", categoryId) + "/edit", {
                ...
                .then((data) => {
                    ...
                    if (data.image) {
                        const imageUrl = `${window.location.origin}/storage/${data.image}`;
                        imageContainer.innerHTML = `<img src="${imageUrl}" class="w-100 h-100" style="object-fit:cover;">`;
                    } else {
