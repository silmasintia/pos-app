                        ...
                        if (data.success) {
                            ...
                            if (imageContainer) {
                                if (stockOpname.image) {
                                    imageContainer.innerHTML = `<img src="${window.location.origin}/storage/${stockOpname.image}" class="w-100 h-100" style="object-fit:cover;">`;
                                } else {
                    ...
                    .then((data) => {
                        if (data.success) {
                            ...
                            if (imageContainerEdit) {
                                if (stockOpname.image) {
                                    imageContainerEdit.innerHTML = `<img src="${window.location.origin}/storage/${stockOpname.image}" class="w-100 h-100" style="object-fit:cover;">`;
                                } else {
