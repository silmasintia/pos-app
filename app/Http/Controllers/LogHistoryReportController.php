...
class LogHistoryReportController extends Controller
{
    ...
    {
        $this->middleware('permission:view-log-histories')->only(['index', 'data', 'show']);
    }
    ...
    public function index()
    {
        ...
        return view('reports.log-histories', compact('users', 'tables', 'actions'));
    }
    ...
    public function data(Request $request)
    {
        $query = LogHistory::leftJoin('users', 'users.id', '=', 'log_histories.user')
            ...
            ->orderBy('log_histories.timestamp', 'desc');
        ...
        return DataTables::of($query)
            ...
            ->editColumn('action', function ($log) {
                switch ($log->action) {
                    ...
                    case 'login':
                        return '<span class="badge bg-info">Login</span>';
                    case 'logout':
                        return '<span class="badge bg-warning text-dark">Logout</span>';
                    default:
