...
class PurchaseController extends Controller
{
    ...
    public function __construct(ImageService $imageService)
    {
        ...
        $this->middleware('permission:view-purchases')->only(['index', 'getPurchasesData', 'show', 'getProducts']);
    ...
    public function index()
    {
        ...
        return view('purchases.index', compact('suppliers', 'cashAccounts'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            if ($request->hasFile('image')) {
                $purchase->image = $this->imageService->saveWebp($request->file('image'), 'purchases');
            }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            if ($request->has('remove_image') && $request->remove_image) {
                $this->imageService->deleteFile($purchase->image);
                $purchase->image = null;
