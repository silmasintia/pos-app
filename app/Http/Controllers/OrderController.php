...
class OrderController extends Controller
{
    ...
    {
        $this->middleware('permission:view-sales')->only(['index', 'getOrdersData', 'show', 'getProducts', 'getProduct', 'printReceipt', 'getCategories']);
        $this->middleware('permission:create-sales')->only(['store']);
        $this->middleware('permission:edit-sales')->only(['updateStatus']);
    }
    ...
    public function index()
    {
        ...
        return view('sales.pos', compact('customers', 'cashAccounts'));
    }
    ...
    public function printReceipt($id)
    {
        ...
        return view('sales.receipt', compact('order', 'profile'));
    }
