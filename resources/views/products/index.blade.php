                ...
                <div class="modal-body">
                    <form id="addProductForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Position <small class="text-muted">(Auto if empty)</small></label>
                                    <input type="number" name="position" class="form-control @error('position') is-invalid @enderror" placeholder="Auto" min="0">
                                    @error('position')
                    ...
                    <form id="editProductForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Position <small class="text-muted">(Auto if empty)</small></label>
                                    <input type="number" name="position" id="edit_position" class="form-control @error('position') is-invalid @enderror" placeholder="Auto" min="0">
                                    @error('position')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
