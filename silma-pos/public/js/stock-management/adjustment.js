                ...
                fetch(adjustmentsViewUrl.replace(":id", adjustmentId), {
                    ...
                    .then((data) => {
                        if (data.success) {
                            ...
                            if (imageContainer) {
                                if (adjustment.image) {
                                    imageContainer.innerHTML = `<img src="${window.location.origin}/${adjustment.image}" class="w-100 h-100" style="object-fit:cover;">`;
                                } else {
                ...
                fetch(adjustmentsEditUrl.replace(":id", adjustmentId), {
                    ...
                    .then((data) => {
                        if (data.success) {
                            ...
                            if (imageContainerEdit) {
                                if (adjustment.image) {
                                    imageContainerEdit.innerHTML = `<img src="${window.location.origin}/${adjustment.image}" class="w-100 h-100" style="object-fit:cover;">`;
                                } else {
