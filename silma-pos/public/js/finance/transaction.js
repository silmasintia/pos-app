document.addEventListener("DOMContentLoaded", function () {
    ...
    if (addTransactionForm) {
        addTransactionForm.addEventListener('submit', function(e) {
            ...
            const btn = document.querySelector('#addTransactionModal .btn-submit');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.edit-btn')) {
            ...
            fetch(transactionsUpdateUrl.replace(':id', transactionId) + '/edit', {
                method: 'GET',
                headers: { 'X-CSRF-TOKEN': csrfToken }
            })
            .then(handleApiResponse)
            .then(data => {
                ...
                document.getElementById('edit_category_id').value = data.transaction_category_id;
                document.getElementById('edit_cash_id').value = data.cash_id;
    ...
    if (editTransactionForm) {
        editTransactionForm.addEventListener('submit', function(e) {
            ...
            const formData = new FormData(this);
            const btn = document.querySelector('#editTransactionModal .btn-submit');
            const spinner = btn.querySelector('.spinner-border');
            const text = btn.querySelector('.btn-text');
            const loadingText = btn.getAttribute('data-loading-text');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-btn')) {
            ...
            confirmDialog('Delete Transaction', `Are you sure you want to delete "${transactionName}"?`)
            .then(result => {
