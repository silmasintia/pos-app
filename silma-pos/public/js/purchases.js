        ...
        $('.view-btn').off('click').on('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (imageContainer) {
                        if (purchase.image) {
                            imageContainer.innerHTML = `<img src="${window.location.origin}/${purchase.image}" class="w-100 h-100" style="object-fit:cover;">`;
                        } else {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    if (imageContainerEdit) {
                        if (purchase.image) {
                            imageContainerEdit.innerHTML = `<img src="${window.location.origin}/${purchase.image}" class="w-100 h-100" style="object-fit:cover;">`;
                        } else {
